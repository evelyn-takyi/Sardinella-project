...
# Genetic Analysis
## Analysis combining both reads of *s. aurita* and *S.maderensis*
...
| 217.311 | 227.027 | 1346    | 1214.14           | 5  | 5  | 4098051    | 2336437      | 292718      | 166888

c. The script  remake_reference.sh was used to remake the reference with the cut off value of K1=3, K2=2, and a c value of 0.9
```
...
##### Create a VCF file of SNPs of outliers with a false discovery rate of 10% using VCFtoOutlierOnly.sh
...
```
### Analysis of neutral SNPs using R
...
# To dos
## Mapping Nigerian samples to reference assembly
## Blast Nigerian samples
## Analyzing maderensis without Nigeria
