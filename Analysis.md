...
```cfallelicprimitives -k -g TRSdp5MIp25.recode.vcf | sed 's:\.|\.:\.\/\.:g' >       TRSdp5MIp25g9.prim
...
```(rad_haplotyper_env) [evelyn-takyi@n038 Aurita_Final2]$ vcftools --vcf SNP.2a.recode.vcf --recode-INFO-all --max-missing 0.5 --out SNP.dp5a --recode
```
...
```(rad_haplotyper_env) [evelyn-takyi@n039 No_NM]$ vcftools --vcf SNP.DP3g95maf05d.recode.vcf  --recode-INFO-all --max-alleles 2 --out SNP.2a --recode
```
