...
| Population |No. of samples		|Private alleles   | Sites | Polymorphic Sites | % Polymorphic Loci | Obs Het | Exp Het |  Fis      | Average coverage per contig|Average contigs mapped|
|————————————|———————————————————|—————————-——————————|——————-|———————————————————|————————————————————|—————————|——————————|———————————|————————————————————————————|————————————————————|
|| Benin     |  19                 |    9             | 1559  | 954              | 61.1931            | 0.266   | 0.1927  |  -0.1339 |  6.5                        |57349                 |
| Guinea     | 12                  |    2             | 1559  | 713              | 45.7344            | 0.2464  | 0.173   | -0.0803  | 4.5                         | 14462                                        |
| Mauritania | 21                  |    5             | 1559  | 902               | 57.8576            | 0.2536  | 0.184  | -0.1189  | 4.7                         | 35576                                        |
| Nigeria    | 15                  |    447           | 1559  | 1013              | 64.9775            | 0.2212  | 0.2501 |  0.1936  | 3.4                         | 13076                                        |
| Senegal    | 18                  |    4             | 1559  | 867               | 55.6126            | 0.2564  | 0.1828 | -0.1227  |  6.8                        | 48290                                        |
| Togo       | 21                  |    2             | 1559  | 885               | 56.7672            | 0.2616  | 0.1883 | -0.1262  |   5.2                       |  35324                                      |
...
```
samtools depth BM_C11-RG.bam  |  awk '{sum+=$3} END { print "Average = ",sum/NR}'
cat BA_2E.cov.stats | awk '$4>0{c++} END{print c+0}'
```
...
| Population |No. of samples		|Private alleles   | Sites  | Polymorphic Sites | % Polymorphic Loci | Obs Het | Exp Het |  Fis      | Average coverage per contig|Average contigs mapped|
|————————————|———————————————————|—————————-——————————|——————-|———————————————————|————————————————————|—————————|——————————|————————— |——————————————————————————|——————————————————————-|
| Benin      |  19               |    9             | 1559    | 954              | 61.1931             | 0.266   | 0.1927  |  -0.1339 |  6.5                      |28674                  |
| Guinea     | 12                |    2             | 1559    | 713              | 45.7344             | 0.2464  | 0.173   | -0.0803  |  4.5                      | 7231                                            |
| Mauritania | 21                |    5             | 1559    | 902              | 57.8576             | 0.2536  | 0.184   | -0.1189  |  4.7                      | 17788                                          |
| Nigeria    | 15                |    447           | 1559    | 1013             | 64.9775             | 0.2212  | 0.2501  |  0.1936  |  3.4                      | 16538                                          |
| Senegal    | 18                |    4             | 1559    | 867              | 55.6126             | 0.2564  | 0.1828  | -0.1227  |  6.8                      |24145                                            |
| Togo       | 21                |    2             | 1559    | 885              | 56.7672             | 0.2616  | 0.1883  | -0.1262  |  5.2                      |  17662                                      |
...
#### Reference assembly generated for Nigerian samples and blast with sequences of s. maderensis from ncbi to determine whether sequence reads from Nigeria could be different.
```
Database: mad
